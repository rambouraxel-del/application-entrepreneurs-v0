...
| V0.6.4 | Intégration commerciale : devis/factures liés dans la fiche client, aperçu Facturation au dashboard, statistiques commerciales sur `facturation.html`, navigation croisée client ↔ devis/facture | En cours |
