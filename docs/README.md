...
- `v1/` — **source de vérité technique de la V1** : `architecture.md` (stack, modules, API, multi-tenant, argent, insights, roadmap technique), `data-model.md` (tables et règles d'intégrité), `security.md` (isolation, RGPD, sauvegardes), `migration-v0-v1.md` (ce qui est repris, réécrit, abandonné), `lot-0-validation.md` (résultats du spike de validation des fondations).
