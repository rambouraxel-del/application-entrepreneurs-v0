...
- **Tableau de bord enrichi** avec des données fictives réalistes :
  ...
  - **Depuis la V0.8**, un bloc compact "Aperçu Trésorerie" (solde estimé, à encaisser, à décaisser, solde prévisionnel à 30 jours, alerte principale) complète le tableau de bord ; la carte KPI "Trésorerie disponible" reflète désormais le vrai solde estimé plutôt qu'une valeur statique. Le 4ᵉ indicateur favori reste inchangé (réservé au futur module Finance).
