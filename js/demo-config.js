...
(function () {
    ...
    var files=['settings-defaults.js','settings-store.js','settings-catalog.js','demo-config-adapter.js','settings-consumers.js','settings-referentials.js','insights-engine.js'];
