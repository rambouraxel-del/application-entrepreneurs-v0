...
(function () {
    ...
    var fields = {
        ...
        'company.footerText': { status:'limited', note:'Utilisé comme valeur de secours si le pied de page Facturation est vide.', keywords:'document pied page' },
        'company.signatureText': { status:'limited', note:'Utilisé comme valeur de secours si la signature Facturation est vide.', keywords:'document signature' },
        ...
        'products.quoteAllowedStatuses': { status:'limited', note:'Filtre les offres proposées dans les nouveaux devis ; les données historiques restent visibles.', keywords:'catalogue devis sélectionnable' },
